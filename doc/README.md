...
2. **学年・クラス** の作成  
   ...
   - クラスを追加する場合：**Core → Class rooms** の「+追加」ボタンから登録  
...
- 設計時に作成したER図：  
  `doc/er/Web課題_ER図.png`

- 本システムでは、既読処理が行われた時点でデータを「過去記録」として扱います。  
- 学年・クラス構成は PoC のため最小構成（1年1・2・3組、2年1・2・3組、3年1・2・3組、各30名）で実装。  
- 長期休暇は仕様上考慮しておりません。（追加機能として実装を検討中）

---

## 6. 注意事項
- 提出データは編集不可のため、誤入力・誤操作時は管理者画面からのデータ修正を行ってください。  
